...
<span class='week' id="weeks">{{week}}</span>
</div>
...
created(){
 ...
 document.getElementById("time").innerHTML = h+":"+m;
  document.getElementById("days").innerHTML =mon+"月"+day+"日";
  document.getElementById("weeks").innerHTML ="星期"+week;
...
/*******************/
.ed{width:700px;float:left;margin:32px;}
...
.info{width:700px;margin:32px;heisght:150px;margin-top:-20px;float:left;border-right:5px solid #fff;}
